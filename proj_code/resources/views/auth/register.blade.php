                        ...
                        <div>
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="first_name" id="firstName" placeholder="First Name here..." type="text"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="last_name" id="lastName" placeholder="Last Name here..." type="text"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="mt-4 d-flex align-items-center">
                                    <h5 class="mb-0">Already have an account? <a href="{{ route('login') }}"
