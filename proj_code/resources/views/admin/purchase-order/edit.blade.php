                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <form id="edit-purchase-order" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" id="purchase-order-route"
                                                   value="{{ route('update-purchase-order') }}">
                                                    ...
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <select name="product_id" id="exampleSelect"
                                                            ...
                                                            @foreach($products as $info)
                                                                <option value="{{$info->id}}" {{$purchaseOrder->product_id == $info->id ? "selected" : ""}}>{{$info->title}}</option>
                                                            @endforeach
                                                    ...
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <select name="supplier_id" id="exampleSelect"
                                                            ...
                                                            @foreach($suppliers as $info)
                                                                <option value="{{$info->id}}" {{$purchaseOrder->supplier_id == $info->id ? "selected" : ""}}>{{$info->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="price" id="priceTitle"
                                                               ...
                                                               type="text" class="form-control" value="{{$purchaseOrder->price}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="quantity" id="quantityTitle"
                                                               ...
                                                               type="text" class="form-control" value="{{$purchaseOrder->quantity}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <button type="submit" data-form-name="edit-purchase-order"
