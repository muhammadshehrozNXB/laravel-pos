                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <form id="edit-suppliers" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" id="suppliers-route"
                                                   value="{{ route('update-suppliers') }}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="name" id="suppliersTitle"
                                                               ...
                                                               type="text" class="form-control" value="{{$suppliers->name}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="phone" id="phoneTitle"
                                                               ...
                                                               type="text" class="form-control" value="{{$suppliers->phone}}">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="email" id="emailTitle"
                                                               ...
                                                               type="email" class="form-control" value="{{$suppliers->email}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="address" id="addressTitle"
                                                               ...
                                                               type="text" class="form-control" value="{{$suppliers->address}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <button type="submit" data-form-name="edit-suppliers"
