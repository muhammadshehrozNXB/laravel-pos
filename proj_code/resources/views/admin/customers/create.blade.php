                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <form id="add-customers" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" id="customers-route"
                                                   value="{{ route('store-customers') }}">
                                            <div class="row">
                                                <div class="col-md-6">
                                            ...
                                            <button type="submit" data-form-name="add-customers"
                                                    data-route="customers-route"
