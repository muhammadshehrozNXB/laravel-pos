                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <form id="add-product-types" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" id="product-types-route"
                                                   value="{{ route('store-product-type') }}">
                                            ...
                                            <button type="submit" data-form-name="add-product-types" data-route="product-types-route"
