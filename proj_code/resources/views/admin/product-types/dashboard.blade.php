                            ...
                            <div class="d-inline-block dropdown">
                                ...
                                <div tabindex="-1" role="menu" aria-hidden="true"
                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a href="{{route("create-products-type")}}" class="nav-link">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                            ...
                            <tbody>
                            @foreach($prodTypes as $key => $items)
                                <tr>
                                    <td>{{$key + 1}}</td>
                                    <td>{{$items->title}}</td>
                                    <td>
                                        ...
                                        <i class="fa fa-business-time fa-w-20"></i>
                                            ...
                                            <div tabindex="-1" role="menu" aria-hidden="true"
                                                ...
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a href="{{url('accounts-pos/products-type/edit/'.$items->id)}}"
                                                           class="nav-link">
                                                            <i class="nav-link-icon lnr-inbox"></i>
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="{{url('accounts-pos/products-type/delete/'.$items->id)}}"
                                                           class="nav-link">
                                                            <i class="nav-link-icon lnr-inbox"></i>
