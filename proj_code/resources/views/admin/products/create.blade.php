                            ...
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        ...
                                        <form id="add-products" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" id="product-route"
                                                   value="{{ route('store-product') }}">
                                            <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        <label for="productTitle" class>Product Name</label>
                                            ...
                                            <button type="submit" data-form-name="add-products"
                                                    data-route="product-route"
