                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <form id="edit-product" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" id="update-product-route"
                                                   value="{{ route('update-product') }}">
                                            <input type="hidden" id="" name="id" value="{{$id}}">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        <label for="exampleSelect" class="">Product Type</label>
                                                        <select name="product_type_id" id="exampleSelect"
                                                                class="form-control">
                                                            <option value="0">Select Product Type</option>
                                                            @foreach($prodTypes as $info)
                                                                <option value="{{$info->id}}" {{$prod->product_type_id == $info->id ? "selected" : ""}}>{{$info->title}}</option>
                                                            @endforeach
                                                ...
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        <label for="productTitle" class>Product Type</label>
                                                        <input name="title" id="productTitle"
                                            ...
                                            <button type="submit" data-form-name="edit-product"
                                                    data-route="update-product-route"
